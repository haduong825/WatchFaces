...
open class PTCardTabBarController: UITabBarController {
    ...
    fileprivate var tabBarHeight: CGFloat = UIScreen.main.bounds.height * 50 / 667
    fileprivate var horizontleSpacing: CGFloat = 70
...
//        customTabBar.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: horizontleSpacing).isActive = true
        customTabBar.widthAnchor.constraint(equalToConstant: tabBarHeight * 200 / 50).isActive = true
